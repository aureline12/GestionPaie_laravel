                                    ...
                                    <span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
                                     ...
                                     c-9.36,0-13.05-2.49-19.76-7.01l-5.07-3.41h-33.2l33.68,125.22h86.23V0z" />
                                                <path style="fill:#FFCD00;"
                                                    d="M232.5,213.76c-24.762,6.63-43.053,29.253-43.053,56.078c0,27.442,14.402,47.104,40.553,55.365
                                ...
                                <div class="col-lg-6 col-xxl-4">
                                    ...
                                    <div class="p-4 total_ card card-custom card-stretch card-stretch-half gutter-b">
                                        ...
                                        <div class="total">
                                            ...
                                            <span>{{ $totalUser }} Utilisateur{{ $totalUser > 1 ? 's' : '' }}</span>
                                            <a href="{{ url('/users') }}" class="theme-dark">voir la liste</a>
                                        </div>
                                        <div class="svg">
                                        ...
                                        <div class="total">
                                            ...
                                            <a href="{{ url('/employe') }}" class="theme-dark">voir la liste</a>
                                        </div>
                                        <!--end::Body-->
                                    </div>
                                    <!--end::Stats Widget 12-->
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-body pt-2">
                                            @forelse ($users as $user)
                                                ...
                                                <div class="symbol symbol-40 symbol-light-success mr-5">
                                                    <span class="symbol-label">
                                                        <img src="/storage/images/{{$user->profile}}" class="h-75 align-self-end" alt="" />
                                                    </span>
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Text-->
                                ...
                                <div class="col-lg-6 col-xxl-4 order-1 order-xxl-2">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-header border-0">
                                            ...
                                            <div class="card-toolbar">
                                                <a href="{{ url('/transaction') }}" class="btn btn-theme">voir tout</a>
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                ...
                                <div class="col-lg-12 col-xxl-4 order-1 order-xxl-2">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-header border-0">
                                            ...
                                            <div class="card-toolbar">
                                                <a href="{{ url('/transaction') }}" class="btn btn-danger">voir tout</a>
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-header border-0 py-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                ...
                                                <span class="text-muted mt-3 font-weight-bold font-size-sm">{{ $totalEmploye }} Employé{{ $totalEmploye > 1 ? 's' : '' }}</span>
                                            </h3>
                                            <div class="card-toolbar">
                                                <a href="{{ url('employe') }}" class="btn btn-theme font-weight-bolder font-size-sm mr-3">voir tous les emplyés</a>
                                                <a href="{{ url('employe/create') }}" class="btn font-weight-bolder font-size-sm"
                                                    style="background-color: #254225;color:#fff">Créer nouveau employé</a>
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                                            ...
                                                            <thead>
                                                                <tr class="text-left text-uppercase">
                                                                    <th style="min-width: 250px" class="pl-7">
                                                                        <span class="text-dark-75">EMPLOYES</span>
                                                                    </th>
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        <td class="pr-0 text-right">
                                                                            <a href="{{ url('employe/' . $employe->id) }}" class="btn  font-weight-bolder font-size-sm"
                                                                                style="background-color:#eeee232a; color:#eeee23">voir le profil</a>
                                                                        </td>
                                                                    </tr>
                                                                @endforeach

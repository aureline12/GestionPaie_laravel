...
<head>
    ...
    <style>
		...
		.fond{
			background-image: linear-gradient(45deg , #eeee2346 50%,#b4eca6b9 5%,#e9121249),url(assets/media/bg/bg-3.jpg);
		}
		.login-divider > div{
			background-color: #b4eca63d !important;
		}
...
<body id="kt_body"
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="login login-6 login-signin-on login-signin-on d-flex flex-column-fluid" id="kt_login">
            <div class="fond d-flex flex-column flex-lg-row flex-row-fluid text-center"
                style="">
                <!--begin:Aside-->
                <div class="d-flex w-100 flex-center p-15">
                    <div class="login-wrapper">
                        ...
                        <div class="text-dark-75">
                            ...
                            <h3 class="mb-8 mt-22 font-weight-bold">APPLICATION DE GESTION DE PAIE</h3>
                            <p class="mb-15 text-muted font-weight-bold">Une administration moderne et performante au service
                                d'un cameroun émergant</p>
                        </div>
                        <!--end:Aside Content-->
                    </div>
                </div>
                    ...
                    <div class="login-wrapper">
                        ...
                        <div class="login-signin">
                            <div class="text-center mb-10 mb-lg-20">
                                ...
                                <p class="text-muted font-weight-bold">Entrez votre email et votre mot de passe</p>
                            </div>
                            <form class="form text-left" action="{{ route('login') }}" method="POST">
                                @csrf
                                <div class="form-group py-2 m-0">
                                    <input style="background-color: rgb(255, 255, 255);"
                                        class="pl-2 form-control h-auto border-0 px-0 placeholder-dark-75" type="email"
                                        placeholder="Email" name="email" />
                                </div>
                                <div class="form-group py-2 m-0">
                                    <input style="background-color: rgb(255, 255, 255);"
                                        class="pl-2 form-control h-auto border-0 px-0 placeholder-dark-75"
                                ...
                                <div
                                    ...
                                    <a href="javascript:;" id="kt_login_forgot"
                                        class="text-muted text-hover-primary font-weight-bold">Mot de passe oublié ?</a>
                                </div>
                                <div class="text-center mt-15">
                                    <button type="submit"
                                        class="btn btn-theme btn-pill shadow-sm py-4 px-9 font-weight-bold">{{ __('Connexion') }}</button>
                                </div>
                            </form>
                        </div>
                        <!--end:Sign In Form-->

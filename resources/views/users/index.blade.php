        ...
        <div class="card card-custom card-stretch gutter-b">
            ...
            <div class="card-header border-0 py-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder text-dark">Informations Utilisateurs</span>
                </h3>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
                            ...
                            <thead>
                                <tr class="text-left text-uppercase">
                                    <th style="min-width: 200px" class="pl-7">
                                        <span class="text-dark-75">Utilisateurs</span>
                                    </th>
                                    <th style="min-width: 30px">Email</th>
                                    <th style="min-width: 30px">Telephone</th>
                                    <th style="min-width: 30px">Role</th>
                            ...
                            <tbody>
                                @foreach($users as  $row)
                                    <tr>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-50 symbol-light mr-4">
                                                    <span class="symbol-label">
                                                        <img width="40px" height="40px" src="{{asset('/storage/images/'.$row->profile)}}" 
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="text-muted font-weight-bold d-block">{{ $row->name }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <span
                                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $row->email }}</span>
                                        ...
                                        <td>
                                            <span
                                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$row->role}}</span>
                                        ...
                                        <td class="text-right pr-0">
                                            ...
                                            <a href="/users/delete/{{$row->id}}" class="btn btn-icon btn-light btn-hover-danger btn-sm deleteuserbtn">
                                                <span class="svg-icon svg-icon-md svg-icon-primary">

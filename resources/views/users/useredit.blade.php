        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="d-flex align-items-center" id="kt_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">Modifier un utilisateur</span>
            ...
            <div class="flex-row-fluid ml-lg-8">
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-header py-3">
                        ...
                        <!--begin::Form-->
                        <form class="form" action="/users/{{ $users->id }}" method="POST"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <select name="role" class="form-control form-control-lg form-control-solid @error('role') is-invalid @enderror" 
                                value="{{ $users->role }}">
